# Activity M02 — Predire il simbolo successivo

## Obiettivo

Applica la dispensa M02 e produci un risultato verificabile.

## Consegna specifica

Calcola e simula distribuzioni next-token, sorpresa e costo ideale in bit.
